...
if (mysqli_connect_errno()) {
    ...
    $selectQuery = "SELECT * FROM `bus` WHERE `Active_status` = 1;";
...
<body>
    ...
    <main style="margin-top: 58px;">
        <div class="main-content pt-4 bg-white p-5 rounded-5">
            <h2 class="text-center my-3">Active Bus</h2>
                    ...
                    <tbody>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<tr>
                                ...
                                <a class='bg-danger text-white p-1 px-2  rounded-5' href='bus-update-unactive.php?id=" . $row["Id"] . "'>Unactice</a>
                            </td>
                                  </tr>";
                        } ?>
