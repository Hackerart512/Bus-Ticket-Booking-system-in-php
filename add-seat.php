...
if (isset($_POST['submit-btn'])) {
    ...
    $sql = "INSERT INTO `Bus_seat`(`Seat_name`) VALUES ('$Seat')";
...
<body>
    ...
    <main style="margin-top: 58px;">
        <div class="main-content pt-4 bg-white p-5 rounded-5">
            <h2 class="text-center my-3">Add Seat</h2>

            <form style="padding: 0px 216px;" class=" my-5 d-flex  justify-content-center flex-column" action="add-seat.php" method="post">

                <div class="my-3 d-flex  align-items-center justify-content-center">
                    <label class="form-label  w-100" for="busname">Capacity of Bus</label>
                    <input name="bus_seat" type="text" id="busname" class="form-control border-dark " />
                </div>
