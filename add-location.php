...
<body>
    ...
    <main style="margin-top: 58px;">
        <div class="main-content pt-4 bg-white p-5 rounded-5">
            <h2 class="text-center my-3">Add Location</h2>
            <form style="padding: 0px 216px;" class=" my-5 d-flex  justify-content-center flex-column" action="add-location.php" method="post">

                <div class="my-3 d-flex  align-items-center justify-content-center mb-5" >
                    <label class="form-label  w-100" for="buslocation">Bus Location</label>
                    <input name="location" type="text" id="buslocation" class="form-control border-dark " />
                </div>
