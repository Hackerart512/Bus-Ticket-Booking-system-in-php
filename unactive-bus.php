...
if (mysqli_connect_errno()) {
    ...
    $selectQuery = "SELECT * FROM `bus` WHERE `Active_status` = 0;";
...
<body>
    ...
    <main style="margin-top: 58px;">
        <div class="main-content pt-4 bg-white p-5 rounded-5">
            <h2 class="text-center my-3">Unactive Bus</h2>
                    ...
                    <tbody>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<tr>
                                ...
                                <a class='bg-primary text-white p-1 px-2  rounded-5' 
                                href='bus-update-active.php?id=" . $row["Id"] . "'>Active</a>
