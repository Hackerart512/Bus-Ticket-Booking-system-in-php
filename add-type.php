...
if (isset($_POST['submit-btn'])) {
    ...
    $sql = "INSERT INTO `bus_type`(`Type`) VALUES ('$Type')";
...
<body>
    ...
    <main style="margin-top: 58px;">
        <div class="main-content pt-4 bg-white p-5 rounded-5">
            <h2 class="text-center my-3">Add Type</h2>
            <form style="padding: 0px 216px;" class=" my-5 d-flex  justify-content-center flex-column" action="add-type.php" method="post">
                ...
                <div class="my-3 d-flex  align-items-center justify-content-center mb-5" >
                    ...
                    <input name="bus_type" type="text" id="bustype" class="form-control border-dark " />
                </div>
